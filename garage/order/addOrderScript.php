...
<body class="text-center m-md-5 p-md-5 p-3 text-light bg-dark">
    ...
    <p><?php echo $e == "" ? '<i class="pe-2 bi bi-check-circle-fill text-success"></i>Objednávka byla přidána do systému, její stav můžete sledovat v mailu.' : ('<i class="pe-2 bi bi-exclamation-circle-fill text-danger"></i>' . $e) ?></p>
